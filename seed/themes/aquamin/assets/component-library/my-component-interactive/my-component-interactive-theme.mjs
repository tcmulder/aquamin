...
console.log(
	'Interactive component module theme loads Wordpress dependency:',
	typeof store === 'function' && typeof getContext === 'function',
);
import classnames from 'classnames';
console.log(
	'Interactive component module theme loads node_modules dependency:',
	typeof classnames === 'function',
);
import fn from './custom-script.js';
console.log(
	'Interactive component module theme loads internal dependency:',
	typeof fn === 'function',
);
fn();
